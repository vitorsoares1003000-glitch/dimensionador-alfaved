...
# Layout Central Organizado em Tabs Estilizadas
tab_resultados, tab_banco = st.tabs(["📊 Simulação do Dimensionamento", "🗄️ Propriedades Físicas do Banco"])

with tab_banco:
    st.markdown("### Constantes Térmicas Indexadas na Memória RAM")
